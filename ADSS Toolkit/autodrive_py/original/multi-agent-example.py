...
def bridge(sid, data):
    if data:
        ...
        v_2.throttle_command = 1 # [-1, 1]
        v_2.steering_command = 1 # [-1, 1]
        v_2.headlights_command = 1 # [0 = disabled, 1 = low beam, 2 = high beam]
        v_2.indicators_command = 3 # [0 = disabled, 1 = left turn indicator, 2 = right turn indicator, 3 = hazard indicator]

        v_3.throttle_command = 1 # [-1, 1]
        v_3.steering_command = 1 # [-1, 1]
        v_3.headlights_command = 1 # [0 = disabled, 1 = low beam, 2 = high beam]
        v_3.indicators_command = 3 # [0 = disabled, 1 = left turn indicator, 2 = right turn indicator, 3 = hazard indicator]

        v_4.throttle_command = 1 # [-1, 1]
        v_4.steering_command = 1 # [-1, 1]
        v_4.headlights_command = 1 # [0 = disabled, 1 = low beam, 2 = high beam]
        v_4.indicators_command = 3 # [0 = disabled, 1 = left turn indicator, 2 = right turn indicator, 3 = hazard indicator]
